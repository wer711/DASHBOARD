...
const COUNTRY_NAMES_AR: Record<string, string> = {
  ...
  TN: 'تونس', DZ: 'الجزائر', MA: 'المغرب', MR: 'موريتانيا', DJ: 'جيبوتي',
  ...
  HK: 'هونغ كونغ', TW: 'تايوان', SG: 'سنغافورة', TH: 'تايلاند', VN: 'فيتنام',
  PH: 'الفلبين', BD: 'بنغلاديش', LK: 'سريلانكا', NP: 'نيبال', AF: 'أفغانستان',
  KZ: 'كازاخستان', UZ: 'أوزبكستان', AZ: 'أذربيجان', AM: 'أرمينيا', GE: 'جورجيا',
  ...
  TZ: 'تنزانيا', UG: 'أوغندا', SN: 'السنغال', CI: 'ساحل العاج', CM: 'الكاميرون',
  AO: 'أنغولا', MZ: 'موزمبيق', BW: 'بوتسوانا', NA: 'ناميبيا', ZW: 'زيمبابوي',
  IL: 'فلسطين المحتلة', XS: 'الضفة الغربية', XG: 'قطاع غزة',
}
