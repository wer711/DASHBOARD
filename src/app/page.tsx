...
import {
  Users, Eye, UserPlus, Sparkles, StickyNote, Share2, TrendingUp,
} from 'lucide-react'
...
export default function Home() {
  ...
  // تتبّع القسم النشط أثناء التمرير
  useEffect(() => {
    const sections = ['overview', 'live', 'audience', 'behavior', 'conversions', 'campaigns']
        ...
        <main className="mx-auto w-full max-w-[1400px] flex-1 px-3 py-4 sm:px-6 sm:py-6">
          ...
          {overview && (
            <div className="space-y-8 sm:space-y-10">
              {/* ====== قسم: نظرة عامة ====== */}
              <section id="section-overview" className="scroll-mt-20 space-y-4 sm:space-y-6">
                <SectionTitle title="نظرة عامة" subtitle="المؤشرات الرئيسية لأداء موقعك" />
              ...
              {/* ====== قسم: البث المباشر ====== */}
              <section id="section-live" className="scroll-mt-20 space-y-4">
                <SectionTitle title="البث المباشر" subtitle="الزوار النشطون الآن وآخر الأحداث لحظياً" />
              ...
              {/* ====== قسم: الجمهور ====== */}
              <section id="section-audience" className="scroll-mt-20 space-y-4">
                <SectionTitle title="الجمهور" subtitle="من أين يأتي زوارك وما هي أجهزتهم" />
                <div className="grid grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
                  <WorldMap
              ...
              {/* ====== قسم: السلوك ====== */}
              <section id="section-behavior" className="scroll-mt-20 space-y-4">
                <SectionTitle title="السلوك" subtitle="الصفحات المُشاهَدة وآخر النشاطات" />
                <div className="grid grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
              ...
              {/* ====== قسم: التحويلات ====== */}
              <section id="section-conversions" className="scroll-mt-20 space-y-4">
                <SectionTitle title="التحويلات" subtitle="مسار التحويل والأحداث المخصصة" />
                <div className="grid grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
              ...
              {/* ====== قسم: الحملات ====== */}
              <section id="section-campaigns" className="scroll-mt-20 space-y-4">
                <SectionTitle title="الحملات" subtitle="مصادر الزيارات والحملات الترويجية" />
                <Campaigns
